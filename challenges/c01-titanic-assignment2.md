...
**Observations**: Class (1st, 2nd, 3rd, Crew), Sex(Male/Female),
Age(Child/Adult), Survived(Yes/No), n (number of people within that
category)
...
- Are there any differences?
  - The article says there were an estimated 2,224 passengers aboard.
    The total computed from the data set is 2,201, which is slightly
    different but not super different.
- If yes, what might account for those differences?
  - The wikipedia article mentions that some reasons the total number of
    passengers is unknown are that some people booked tickets and didn’t
    show up and some did not stay onboard the entire journey
  - Another potential reason for this different might be that there were
    estimated to be more passengers onboard than there is recorded data
    of, so only the passengers with known data to fill the data set are
    included.
  - …
...
**Observations**: In general, it looks like more women survived than
men, with the exception being crew, which I think can be explained by
the fact that women likely made up a very small percentage of the crew.
It’s also interesting that the number of crew that survived is higher
than any of the other classes - could this have to do with the
proportion of the boat that was made up of crew (i.e. there were more
crew so more crew survived).
...
- Write your observations here.
  - For every class, the same proportion or more women survived than
    men.
  - A significantly larger proportion of the first and second classes
    survived than third class or crew, which makes sense given that
    first and second class passengers would likely be prioritized.
  - Even though the greatest number of male crew survived, looking at
    the proportions it’s actually the case that the lowest proportion of
    male crew survived compared to the other sex/class groups.
- Is there anything *fishy* going on in your plot?
  - It doesn’t seem accurate that 100% of all of first and second class
    survived
...
- The proportion of females who survived is always equal to or higher
  than that of males who survived within a given class and within a
  given age group. In general, it seems that regardless of what class or
  age you were, you would be given priority if you were a woman.
- In general, higher proportions of children survived than adults, so it
  seems that children’s lives were also prioritized.
- There is a much bigger difference between the proportion of passengers
  who survived from 2nd to 3rd class than from 1st to 2nd class.
- If you saw something *fishy* in q4 above, use your new plot to explain
  the fishy-ness.
  - 100% of first and second class children survived, which explains why
    it appeared on the previous graph as though 100% of all first and
    second class passengers survived, but also makes significantly more
    sense given that children were generally prioritized.
