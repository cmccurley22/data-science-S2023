...
**Observations**: - Write your observations here! - One thing that’s
interesting to see is the images with the highest distinctness have a
mean velocity closest to Michelson’s value for the speed of light, while
the images with the lowest distinctness are closest to the true speed of
light in a vacuum. - Why might your table differ from Michelson’s? - How
he approached the calculations and rounding in different places likely
led to different results than me just plugging it into my computer.
...
uncertainty is about a third of his error
...
- There doesn’t seem to be any correlation between temperature and
  measured velocity
- There doesn’t really seem to be a correlation between distinctness and
  measured velocity - the mean velocity does increase as distinctness
