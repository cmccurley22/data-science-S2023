...
```
    ...
    ## $ `Estimate!!Total`        <dbl> NA, 55200, 208107, 25782, 22527, 57645, 10352…
...
- Loving had the highest number of cases per 100k people, which is much
  higher than the mean. Looking closer at the data, Loving at one point
...
What is happening in loving?

``` r
df_normalized %>%
  filter(county == df_cases_top10$county) %>%
...
relatively similar rates, but Loving doesn’t even start rising until
months after many of the others - Does this have something to do with
how Loving was reporting or recording data?
...
in deaths per 100k people in Loving, TX. How did everyone die on one
day? - Then I realized - the county is literally so tiny, that feasibly
that spike could literally be one person dying. That’s wild. - Thinking
now about the tiny population of Loving, this could explain why it’s
such an outlier on the cases per 100k graph, and why the number of cases
per 100k grows so quickly (just one or two cases can cause the cases per
100k to go up by a ton)

Some interesting things about Loving, TX (I found a news article!
<https://abc13.com/loving-county-texas-coronavirus-smallest-in-us-population/8066432/>) -
It is the county with the lowest population in the contiguous US - It
was the last county in TX to report covid cases

Another article, titled “COVID is Everywhere, Even in”the Last Covid
Free County”
<https://www.texasmonthly.com/news-politics/covid-loving-county/> - It
was the last county anywhere in the US to have 0 reported cases of
Covid - however, according to this article covid did exist there but was
not spread / caught there - Reading this article, it sounds like the
small number of people means that it’s not spreading amongst those in
Loving - people are travelling elsewhere and catching covid, which is
not counted in the county’s numbers, but they’re not gathering within
the county enough to cause spread of the disease - this would also help
explain why the number of cases stayed at 0 for so long compared to the
other top 10 cases per 100k counties
