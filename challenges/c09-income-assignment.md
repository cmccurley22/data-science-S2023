...
filename_income <- "./data/income_data.csv"
...
I want to look at how family size, population estimate, and median
household income tie into eachother.
...
**Observations**: - there doesn’t really seem to be a trend between
population size and average income - more counties have lower average
income than higher (points are more clustered towards the lower end of
average income, then much more scattered once you get above around
120k) - generally speaking, 4-6 person families tend to have higher
income than 2-3 person families, but it once again doesn’t necessarily
seem like there’s a huge correlation between category and income outside
those two sets (i.e. there’s not much of a correlation in 4 vs 5 vs 6
person families)
